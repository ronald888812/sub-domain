  ...
  {{-- <div class="content-wrapper"> --}}
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><i class="fa fa-product-hunt"></i> User  </li>
        </ol>
    </section>
    <br>
     <!-- Main content -->
        <section class="content container-fluid">
            {{-- <div class="form-group col-md-12">
                <div class="pull-right">
                    <a href="{{ route('user.create') }}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Tambah User</a>
                </div>
            </div> --}}
            <br>
                    ...
                    <tbody id="">
                        ...
                        @foreach ($indexs as $key => $index)
                            <tr>
                                ...
                                <td>
                                <center>
                                   <a href="{{ route('user.edit',$index->id) }}"><button class="btn btn-primary btn-xs" title="Ubah"><i class="fas fa-pencil-alt"></i></button></a>
